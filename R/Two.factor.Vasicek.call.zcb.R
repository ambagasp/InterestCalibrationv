#' Value of call on a zero-coupon bond.
#' 
#' The call option is  on a zero coupon bond when underlying model is two-factor Vasicek model.
#' 
...
#'@export
Two.factor.Vasicek.call.zcb = function(TO,TB,K,ZTO,ZTB,phi1,phi2,gamma1,gamma2,sigma1,sigma2,rho){

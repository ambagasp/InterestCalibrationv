#'Price of a call option on a zero-coupon bond under Hull-White model.
#'
...
#'@export
Hull.White.call.zcb = function(TO=1,TB=5,K=0.8,gamma=0.019,sigma=0.0196,ZCBTB=0.7978,ZCBTO=0.9790){
